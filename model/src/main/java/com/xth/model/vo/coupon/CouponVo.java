package com.xth.model.vo.coupon;
...
public class CouponVo extends AbstractVo {
    ...
    /**
     * 如果是满减,比如满500减100，保存500，100
     */
    @ApiModelProperty("如果是满减,比如满500减100，保存500，100")
     ...
     * 展示的适用范围
     */
    @ApiModelProperty("展示的适用范围")
    private String applyScopeContent;
